...
import { ActivityIndicator, FlatList, Image, KeyboardAvoidingView, Modal, Platform, Pressable, SafeAreaView, StyleSheet, Text, TextInput, View } from "react-native";
    ...
    <View style={s.profileCard}>
      ...
      <View style={s.profileBody}>
        ...
        <View style={s.profileStats}>
          <View style={s.statPill}><Text style={s.statIcon}>◉</Text><Text style={s.statValue}>{timelineCounts.all}</Text></View>
          <View style={s.statPill}><Text style={s.statIcon}>▣</Text><Text style={s.statValue}>{timelineCounts.completed}</Text></View>
          <View style={s.statPill}><Text style={s.statIcon}>✎</Text><Text style={s.statValue}>{(bundle?.journal || []).length}</Text></View>
        </View>
